...
# This script checks and installs all dependencies which are needed to run renvveyult. After that, it clones the repo.
# Execute this easily with /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PJF16/renvveyult/master/installer/macOSinstaller.sh)
...
echo "Starting check and installation process of dependencies for renvveyult"
...
REPO_URL="https://github.com/renvvey/renvveyult.git"
REPO_NAME="renvveyult"
