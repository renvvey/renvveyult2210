...
set INSIGHTFACE_PACKAGE_URL=https://github.com/renvvey/renvveyult/releases/download/3.6.6/insightface-0.7.3-cp310-cp310-win_amd64.whl
REM Note: If the wheel is not available in this repo, download manually or use pip install insightface after environment setup.
